...
# La Escala de color es Rojo, Blanco, Azul

# Si se desea cambiar Rojo, Amarillo y Verde, poner sel siguiente codigo donde corresponda
...
#' DashBEER_heatmap
#'
#' @param datos Un data.frame cuya primera columna es la fecha, seguido por las variables que seran las filas del mapa de calor 
#' @param n_ultimos Numero de observaciones finales que se mostraran en la columnas del mapa de calor 
#'
#' @return Regresa el mapa de calor de las columnas de los datos ingresados
#' @export
#'
#' @examples

DashBEER_heatmap_V1.0 <- function(datos, n_ultimos=8, titulo=""){
